...
const printMsg = function (){
    console.log("this is a functino");
}
...
// js의 함수는 호출 시 이름으로만 판단함 매개변수는 있어도 되고 없어도 괜찮다.

greet();
greet("최수만")

// null을 사용하면 개발자가 빈값을 지정해주는 것이기 때문에 null을 변수에 대입하고
// undefined를 사용하면 시스템적으로 빈값을 처리하는 뜻으로 기본값이 적용된다.
...
// 함수의 내용에 return 값만 있다면 return키워드와 {}를 생략가능
const minus = (a, b) => a - b;
console.log("10-5:", minus(10,5));
// const minus = (a, b) => {
//     return a - b;
// }
//전달할 매개변수가 한개라면 ()도 생략가능
const square = x => x * x;
